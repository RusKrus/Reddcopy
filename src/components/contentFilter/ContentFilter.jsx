...
import { clearPosts } from "../feedArea/feedAreaSlice.js";
...
function ContentFilter(props) {
    ...
    return (
        <div className={styles.contentFilter}>
            <NavLink className={styles.paramNavLink} onClick={handleTopClick}  >
            ...
            <NavLink className={styles.paramNavLink} onClick={handleHotClick} >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={styles.filterIcon}>
            ...
            <NavLink className={styles.paramNavLink} onClick={handleNewClick} >
            ...
            <NavLink className={styles.paramNavLink} onClick={handleRisingClick} >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={styles.filterIcon} >
