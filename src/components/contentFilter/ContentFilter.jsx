...
function ContentFilter() {
    return (
        <div className={styles.contentFilter} data-testid="content-filter">
            ...
            <NavLink to="/hot" className={({ isActive }) => isActive ? styles.paramButtonActive : styles.paramButton}  >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={styles.filterIcon}>
            ...
            <NavLink to="/new" className={({ isActive }) => isActive ? styles.paramButtonActive : styles.paramButton} >
            ...
            <NavLink to="/rising" className={({ isActive }) => isActive ? styles.paramButtonActive : styles.paramButton}  >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={styles.filterIcon} >
